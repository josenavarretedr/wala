    ...
    <div class="bg-white border-b border-gray-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex items-center justify-between">
          ...
          <h1 class="text-xl font-bold text-gray-900">Detalles de Evento</h1>
          <div class="w-20"></div>
        </div>
      </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          >
            ...
            <div class="flex items-center gap-3">
              <Calendar class="w-5 h-5 text-gray-400" />
              <div>
                <p class="text-xs text-gray-500">Fecha de Fin</p>
                <p class="text-sm font-medium text-gray-900">
          ...
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
              ...
              >
                {{
                  hasParticipation
                    ? `Tu asistencia fue marcada el ${formatDate(
                        participation?.submittedAt
                      )}`
                    : "Aún no se ha registrado tu asistencia para este evento"
                }}
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-blue-600">
                Materiales y recursos del evento
              </p>
            </div>
            <svg
...
import { Calendar, CheckCircle, WarningCircle } from "@iconoir/vue";
...
const hasParticipation = computed(() => {
  return (
    participation.value && participation.value.attendance?.attended === true
  );
});
...
const whatsappLink = computed(() => {
  ...
  const message = encodeURIComponent(
    `Hola, quiero marcar mi asistencia del evento "${
