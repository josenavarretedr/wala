    ...
    <div class="bg-white border-b border-gray-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex items-center justify-between">
          ...
          <h1 class="text-xl font-bold text-gray-900">Detalles de Sesión</h1>
          <div class="w-20"></div>
        </div>
      </div>
    </div>
          ...
          >
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-sm font-medium text-gray-900">
                  {{ activity.sessionTime || "Por definir" }}
                </p>
              </div>
            </div>
              ...
              >
                {{
                  hasParticipation
                    ...
                    : "Aún no se ha registrado tu asistencia para esta sesión"
                }}
              </p>
            </div>
          </div>
...
import { Book, Calendar, CheckCircle, WarningCircle } from "@iconoir/vue";
...
const whatsappLink = computed(() => {
  ...
  const message = encodeURIComponent(
    `Hola, quiero marcar mi asistencia de la sesión "${
