    ...
    >
      ...
      >
        ...
        <div>
          ...
          <div class="space-y-2">
            <div
              v-for="(payment, index) in transactionStore.transactionToAdd.value.payments"
              :key="index"
      ...
      <div v-if="hasValidData" class="p-4 border-b border-gray-100">
        <div
          :class="[
            'grid gap-3',
            transactionStore.transactionToAdd.value.supplierId
              ? 'grid-cols-3'
              : 'grid-cols-2',
          ]"
        >
          ...
          <!-- Proveedor -->
          <div
            v-if="transactionStore.transactionToAdd.value.supplierId"
          ...
          >
            ...
            <div class="text-sm font-medium text-purple-700 truncate px-1" :title="transactionStore.transactionToAdd.value.supplierName">
              {{ transactionStore.transactionToAdd.value.supplierName }}
            </div>
          </div>
        </div>
      </div>
