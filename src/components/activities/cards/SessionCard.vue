<template>
  <div
    @click="handleClick"
    class="bg-white rounded-xl shadow-sm border border-blue-200 p-4 transition-all duration-200 hover:shadow-md hover:border-blue-300 cursor-pointer relative"
  >
